...
import { MapPin, Calendar, Clock, Info, CreditCard, Minus, Plus, AlertCircle, User as UserIcon, Ban, Trash2, Pencil, X, Save, Image as ImageIcon, BarChart, List, Flame } from 'lucide-react';
                     ...
                     <table className="w-full">
                         <thead>
                             <tr className="bg-gray-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                 <th className="px-4 py-2 rounded-l-lg">PR List</th>
                                 <th className="px-4 py-2 rounded-r-lg text-right">Tickets Sold</th>
                             </tr>
                         </thead>
                         <tbody className="divide-y divide-gray-100">
                             {Object.entries(prStats).map(([name, count]) => (
                                 <tr key={name}>
                                     ...
                                     <td className="px-4 py-3 text-right text-indigo-600 font-bold">{count}</td>
                                 </tr>
                             ))}
                         </tbody>
                         <tfoot>
                             <tr className="border-t border-gray-200">
                                 ...
                                 <td className="px-4 py-3 text-right font-bold text-indigo-600">
                                    {Object.values(prStats).reduce((a: number, b: number) => a + b, 0)}
                                 </td>
                             </tr>
                         </tfoot>
                     </table>
