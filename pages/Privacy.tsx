        ...
        <div className="prose prose-invert max-w-none text-gray-300 space-y-6 text-sm md:text-base leading-relaxed">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full text-left text-sm border border-white/10 mt-2">
                    <thead className="bg-gray-900/50 font-bold">
                        <tr>
            ...
            <section className="bg-red-950/20 border-l-4 border-red-600 p-6 rounded-r-xl shadow-sm mb-8">
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl border border-white/5 text-sm">
                ...
                <p className="mb-1"><strong>Titolare del Trattamento:</strong> UniParty Team</p>
                <p className="mb-1"><strong>Indirizzo:</strong> Palermo, Italia</p>
